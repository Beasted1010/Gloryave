...
static void AUD_Callback(AUD_Sound* data, Uint8* stream, int len) {
...
AUD_Sound* AUD_LoadWAV(const char* wav, int loop) {
    ...
    //THIS IS LIKELY WRONG (THE CASTING TO SDL_AUDIOCALLBACK...)
    product->spec.callback = SDL_AudioCallback(AUD_Callback);
